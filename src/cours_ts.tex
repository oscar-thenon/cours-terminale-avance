...
\begin{figure*}[b]
    \centering
    \href{https://creativecommons.org/licenses/by-sa/4.0/}{\includegraphics{figures/png/by-sa.png}}
\end{figure*}
...
\include{chapters/1_les_fondamentaux}
\include{chapters/2_suites_reelles}
\include{chapters/3_nombres_complexes}
\include{chapters/4_geometrie_dans_lespace}
\include{chapters/5_fonctions}

\begin{appendix}

\include{chapters/A_preuve_du_theoreme_fondamental_de_lanalyse}
\include{chapters/B_existence_de_la_fonction_exponentielle}
